...
import com.example.loginex01.databinding.ActivitySigninBinding;
import com.example.loginex01.models.model.UserModel;
import com.example.loginex01.models.repository.LocalRepository;
import com.example.loginex01.viewmodels.SignInViewModel;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra("email") != null) {
            ...
            Toast.makeText(this, "Ecocast 기존 회원입니다.", Toast.LENGTH_SHORT);
        }
    }

    Observer<Integer> btnClickObserver = integer -> {
        if (integer != null) {
    ...
    Observer<ArrayList<UserModel>> signInViewModelObserver = new Observer<ArrayList<UserModel>>() {
        @Override
        public void onChanged(@Nullable ArrayList<UserModel> arrayList) {
            if (arrayList != null && !arrayList.isEmpty()) {
                ...
                if (userModel.getNon_field_errors() != null) {
                    ...
                    Toast.makeText(SignInActivity.this, userModel.getPassword(), Toast.LENGTH_SHORT).show();
